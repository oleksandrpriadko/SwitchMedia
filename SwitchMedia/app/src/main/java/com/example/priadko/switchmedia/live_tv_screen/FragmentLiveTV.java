package com.example.priadko.switchmedia.live_tv_screen;
...
public class FragmentLiveTV extends FragBaseAbstract {
    /**
    ...
    protected void prepareViews(View rootView) {
        ((TextView) rootView.findViewById(R.id.textView_title)).setText(R.string.tab_live_tv);
    }
}
