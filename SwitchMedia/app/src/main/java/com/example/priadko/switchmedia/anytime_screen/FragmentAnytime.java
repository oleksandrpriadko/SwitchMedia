package com.example.priadko.switchmedia.anytime_screen;
...
public class FragmentAnytime extends FragBaseAbstract {
    /**
    ...
    protected void prepareViews(View rootView) {
        ((TextView) rootView.findViewById(R.id.textView_title)).setText(R.string.tab_anytime);
    }
}
